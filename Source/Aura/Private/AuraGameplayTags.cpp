...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Event_Montage_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Casting FireBlast from montage"));
	...
	GameplayTags.Event_Montage_ArcaneShards = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Casting ArcaneShards from montage"));
	...
	GameplayTags.Player_Block_NiagaraClick = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Player.Block.NiagaraClick"),
		FString("Block spawning niagara click system"));
}